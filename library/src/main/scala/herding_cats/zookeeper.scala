...
trait Zookeepers {
  ...
  type ZKConnFactory[S] = (String, S, (WatchedEvent, S) => PromisedResult[S]) => ZK
   ...
   */
  def withZK[S](controlPath: String, factory: ZKConnFactory[S], initial: S)(body: ZK => ZKState[S, Unit]) {
    import Zookeepers._
